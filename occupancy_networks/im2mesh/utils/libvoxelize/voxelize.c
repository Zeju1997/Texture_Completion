...
extern int __pyx_module_is_main_im2mesh__utils__libvoxelize__voxelize;
...
(void)(__pyx_f_7im2mesh_5utils_11libvoxelize_8voxelize_voxelize_triangle_(__pyx_v_occ, __pyx_t_4, 0));
...
static PyMethodDef __pyx_methods[] = {
  {"voxelize_mesh_", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7im2mesh_5utils_11libvoxelize_8voxelize_1voxelize_mesh_, METH_VARARGS|METH_KEYWORDS, 0},
  {"voxelize_triangle_", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7im2mesh_5utils_11libvoxelize_8voxelize_3voxelize_triangle_, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init im2mesh.utils.libvoxelize.voxelize", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
