...
#args.in_folder = os.path.join(os.path.abspath(os.getcwd()), 'data/ColoredSDF/example')
    #args.pointcloud_folder = os.path.join(os.path.abspath(os.getcwd()), 'out')
    #print(os.path.join(os.path.abspath(os.getcwd()), 'data/ColoredSDF/example'))
    main(args)
